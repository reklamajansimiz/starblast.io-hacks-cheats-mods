// ==UserScript==
// @name         Starblast.io AIMBOT - Starblastio Hacks - Best Starblast Cheat 2019 to 2020
// @description  Starblastio Mods Features: AimBot, Auto Heal, Speed Hack, Jet Speed, Extra Features, FPS, Adblock
...
// @updateURL    https://io-mods.com/mods/starblastio.user.js
// @downloadURL  https://io-mods.com/mods/starblastio.user.js
// @grant        GM_setValue
// @grant        GM_getValue
// @match        *://starblast.io/*
// @match        *iogames.space/*
...
text += '<a href="http://'+value+'" target="_blank" style="'+ministyler+'">'+value2+' <font color="#555555">-</font></a>';
    ...
    //ozellikler
    var fts = ["Aimbot","Speed Hack","Zoom Hack","Fire Bot","Auto Fire","Auto Skin","Auto Heal","Minimap+","Auto Feed","Anti Lag","Anti Ads"];
...
//degisenkisimlar
$('.full-changelog').prepend('<div style="'+this.st.fpsstyle+'" id="fps" class="fps"></div>');
$('.bottom-left').prepend('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('.frozenbg').html('<div class="list1"></div>');
...
document.getElementById("player").appendChild(stylerSelect);
...
function changebackground() {
    ...
    $(".bottom-left").css("background-color",rgbaC2);
	    $(".frozenbg").css("background-color",rgbaC2);
}
...
function colorfulmod() {
    ...
    colorsrain = ["transparent"];
      ...
      setInterval(function() {
          ...
          $(".bottom-left").css("background-color",rgbaCol);
		   $(".frozenbg").css("background-color",rgbaCol);
      }, 3000);
}
